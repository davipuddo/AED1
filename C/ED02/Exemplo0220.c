...
int main (void)
{
    ...
    clrscr  ();
    println ("853355_AED1");
    println ("Ler tres valores e dizer se o primeiro nao esta entre os dois ultimos, quando todos eles forem diferentes entre si. ");
    ...
    //Resultados
    if (x != y && x != z && y != z)              //Se os tres valores forem diferentes
      {
        if ((y > x && z < x) || (z > x && y < x))
         {
                clrscr  ();
    ...
    else                                         //Se dois ou tres valores forem iguais
      {
        clrscr  ();
        println ("Os valores digitados sao invalidos. ");
      }
