...
int main (void)
{
    ...
    clrscr  ();
    println ("853355_AED1");
    println ("Dizer se um valor inteiro pertence ao intervalo fechado [15:60]. ");
    ...
    if (15 <= x && x <= 60)
      {
        println ("");        //Pular uma linha
        println ("O valor fornecido pertence ao intervalo fechado [15:60]. ");
      }
    else
     {
        println ("");        //Pular uma linha
        println ("O valor fornecido nao pertence ao intervalo fechado [15:60]. ");
     }
